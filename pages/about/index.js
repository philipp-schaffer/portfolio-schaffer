...
const About = () => {
  ...
  return (
    <div className="xl:h-[100vh] text-center xl:text-left py-32 relative">
      <Circles></Circles>
      <motion.div
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div>
            ...
            >
              ...
              done remote work for agan encies, consulted for startups, and
              colla borated on digital products for business and customer use.
            </motion.p>
            <motion.div
