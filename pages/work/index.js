      ...
      <div className="container h-full mx-auto">
        <div className="flex flex-col xl:flex-row gap-x-8">
          <div className="text-center flex xl:w-[30vw] flex-col mb-4 lg:text-left xl:mb-0">
            ...
            >
              During my time as a student at the HTL Spengergasse I crafted over
              50 projects and additionally worked part-time for 2+ years as
              Junior Dev/Graphic Designer at Austria IT Consulting Company
            </motion.p>
          </div>
          <motion.div
